  ...
  render() {
    ...
    <View style={styles.containerMain}>
      <View style={styles.box1}>
          <Text style={{ textAlign: 'center', padding: 30, fontSize: 25, color: 'black'}} >Prakiraan Cuaca</Text>
      </View>
      ...
      <View style={styles.box4}>
          <Text style={{ textAlign: 'center', padding: 18, fontSize: 14}} >CopyRight wandi@App</Text>
      </View>
</View>
    );
  }
